...
namespace ConsolaPruebas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrestamoDolar pd1 = new PrestamoDolar(1500, new DateTime(2021, 11, 01),
            PeriodicidadDePagos.Mensual);
            PrestamoDolar pd2 = new PrestamoDolar(2000, new DateTime(2022, 12, 05),
            PeriodicidadDePagos.Bimestral);
            PrestamoDolar pd3 = new PrestamoDolar(2500, new DateTime(2025, 01, 01),
            PeriodicidadDePagos.Trimestral);
            PrestamoPesos pp1 = new PrestamoPesos(8000, new DateTime(2024, 01, 01), 20);
            PrestamoPesos pp2 = new PrestamoPesos(7000, new DateTime(2001, 10, 01), 25);
            PrestamoPesos pp3 = new PrestamoPesos(5000, new DateTime(2023, 11, 20), 20);
            ...
            pd1.ExtenderPlazo(new DateTime(2021, 12, 01));
            pp1.ExtenderPlazo(new DateTime(2024, 02, 01));
